...
public class deletionService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        Notification popup = new Notification.Builder(this).setContentTitle("Photo is deleted").setContentIntent(pendingintent).setSmallIcon(R.drawable.ic_add).setAutoCancel(true).build();
