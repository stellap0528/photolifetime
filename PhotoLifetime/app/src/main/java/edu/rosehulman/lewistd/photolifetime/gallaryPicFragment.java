...
// */
//public class gallaryPicFragment extends Fragment implements MediaAdapter.Callback{
//
//    private Uri mUri;
...
////        mFragmentTransaction.detach(getActivity().getSupportFragmentManager().findFragmentByTag("GAL"));
////        mFragmentTransaction.attach(getActivity().getSupportFragmentManager().findFragmentByTag("LIST"));
////        mFragmentTransaction.replace(R.id.container, getActivity().getSupportFragmentManager().findFragmentByTag("LIST"));
